  ...
  return (
    <div className="min-h-screen pt-20 bg-white">
      ...
      <QuickWins onWinClick={setSelectedWin} />
        ...
        {/* Stage Selection Cards - Bottom Section - Show if no quiz answers */}
        {!quizAnswers && !showQuiz && (
          <section className="py-8">
            <div className="text-center mb-6">
              <h3 className="font-manrope font-bold text-xl text-foreground mb-1">Skip the quiz — choose your stage</h3>
              <p className="text-sm text-muted-foreground">Quick access to pathways</p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              {['Idea / Pre-Seed', 'Seed', 'Series A', 'Series B', 'Series B+', 'Bootstrapped'].map(stage => (
                <button
                  ...
                  className="bg-white border border-border rounded-xl p-3 hover:border-primary hover:shadow-md transition-all duration-300 text-center group"
                >
                  <div className="font-manrope font-semibold text-sm text-foreground group-hover:text-primary transition-colors">{stage}</div>
                </button>
              ))}
            </div>
          </section>
